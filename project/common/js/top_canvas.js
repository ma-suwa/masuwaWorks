...
function createCanvas(){
  ...
  myCanvas.style.backgroundColor = "#ececec";
...
class Line extends createjs.Shape {
  constructor(x1, y1, x2, y2, x3, y3, i, color) {
    ...
    // this.graphics.beginStroke(color).setStrokeStyle(0.2).moveTo(x1,y1).lineTo(x2, y2);
  }
  update() {
...
class Curves extends createjs.Container {
  constructor() {
    ...
    // var curve1_5 = new Curve(8, 2, 180, 1, 42, white);
    // this.addChild(curve1_5);
    ...
    // var curve2_6 = new Curve(2, -4, 90, 1, 2, white);
    // this.addChild(curve2_6);
    ...
    // var curve3_6 = new Curve(-2, 8, 90, -1, 0, white);
    // this.addChild(curve3_6);
